...
try {
    ...
    Invoke-External -File sql26 -Args @('-name', 'dev', '@src/scripts/during/next_cycle_project_export.sql')
    Write-Host
    ...
    Invoke-External -File sql26 -Args @('-name', 'dev', '@src/scripts/during/next_cycle_project_stage.sql')
    ...
    Invoke-External -File sql26 -Args @('-name', 'dev', '@src/scripts/during/next_cycle_project_release.sql', $Version)
    ...
    Write-Host "  sql26 -name prod @src/scripts/during/next_cycle_project_deploy.sql $Version"
