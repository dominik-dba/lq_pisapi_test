/*
CREATE TABLE "PIS_STORITVE_POS"."LB_CHANGESLOCK"
...
CREATE TABLE "PIS_STORITVE_POS"."LB_CHANGES"
...
-- locked = 0
Insert into PIS_STORITVE_POS.LB_CHANGESLOCK (ID,LOCKED,LOCKGRANTED,LOCKEDBY) values ('1','0',to_timestamp('24.06.26 09:17:41,785884000','DD.MM.RR HH24:MI:SSXFF'),'W012823 (192.168.2.132)');
commit;
*/
